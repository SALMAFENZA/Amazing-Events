...
function printCard(tarjetas) {
  //esta funcion imprimira tarjetas

  for (let evento of events) {
    // aca guardamos en -evento- cada vez que se ejecuta una vuelta, un evento
    ...
    <div class="card-body d-flex justify-content-between">
                <P class="p-3 border border-dark rounded-pill"> ${evento.price} </P>
                <a href="./moredetails.html" class="p-2 card-link border border-dark rounded-pill d-flex align-self-center justify-content-center">More details</a>
    </div>
    </div>
    `
    }
